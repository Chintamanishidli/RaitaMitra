    ...
    <div className="font-sans text-[#0f3d25] bg-[#F4F8F5] py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-slate-700 text-lg leading-relaxed">Raita Mitra Social Trust (R) is a grassroots non-profit organization focused on healthcare outreach, farming upgrades, and rural education in Karnataka.</p>
        </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <p className="text-white/80 leading-relaxed">Founded in Koppal, Karnataka, Raita Mitra ("Farmer's Friend") was born out of a simple observation: rural populations faced severe gaps in accessing modern agricultural technologies and quality medical treatments.</p>
            <p className="text-white/80 leading-relaxed">We started by organizing small-scale workshops to teach soil testing and crop diversification. Recognizing that physical health is the foundation of economic security, we expanded our operations to sponsor medical treatments, partnering with leading multi-specialty hospitals like Srinivasa Hospital to bring top surgeons to village doorsteps.</p>
            <p className="text-white/80 leading-relaxed">Today, Raita Mitra stands as a trusted network of volunteers, doctors, agronomists, and social workers, dedicated to community upliftment.</p>
          </div>
        ...
        <section className="bg-cream-card rounded-3xl p-8 sm:p-12 border border-accent-green/15 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-8 space-y-6 text-left">
            ...
            <h2 className="font-display font-black text-3xl sm:text-4xl text-white">Sri C.V. Chandrashekar</h2>
            ...
            <blockquote className="border-l-4 border-accent-green pl-4 text-white/70 italic text-sm">
            ...
            <p className="text-white/80 leading-relaxed text-sm sm:text-base">Under his patronage, the trust has organized free clinical checks, laboratory tests, and distribution of medicines to thousands of villagers.</p>
          </div>
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-[11px] font-semibold text-slate-600 text-center italic">Sri C.V. Chandrashekar and trust members at a mega health camp.</p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, i) => (
              <div key={i} className="bg-white p-8 rounded-3xl border border-accent-green/5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-left space-y-4">
                ...
                <h3 className="font-display font-bold text-lg text-white">{value.title}</h3>
